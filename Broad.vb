...
Public Class Broad
 ...
 Function SubXL%(ByRef ref1&, ByRef ref2&, dsz%, sz2&) ', Optional byteOffs% = 0)
	...
	Public Shared Sub LTrim(ByRef xl As Broad)
		With xl
			u% = findTopDigit(.BufferSize, .buff(UBound(.buff)))
			If u > .PartSize Then

				ReDim Preserve .buff(u%)
			Else
				ReDim Preserve .buff(.PartSize + 1)
			End If
		End With
